...
class pygame2exe(py2exe.build_exe.py2exe):
    def copy_extensions(self, extensions):
        ...
        pygame_default_font = os.path.join(
            pygamedir, pygame.font.get_default_font())
        # 加入拷贝文件列表
...
class BuildExe:
    def __init__(self):
        ...
        # 起始py文件
        self.script = "pymine.py"
        # 游戏名
        self.project_name = "Minefield"
        # 游戏site
        self.project_url = "http://www.imzhao.net"
        # 游戏版本
        self.project_version = "0.6.0.0"
        # 游戏许可
        self.license = "Free"
        # 游戏作者
        self.author_name = "zhaoxin"
        # 联系电邮
        self.author_email = "archtaurus@gmail.com"
        # 游戏版权
        self.copyright = "Copyright (c) 2013 zhaoxin."
        # 游戏描述
        self.project_description = "Minefield"
        # 游戏图标(None的话使用pygame的默认图标)
        self.icon_file = "resource/icon/pymine.ico"
        # 额外需要拷贝的文件、文件夹(图片，音频等)
        self.extra_datas = []
        # 额外需要的python库名
        self.extra_modules = []
        # 需要排除的python库
        self.exclude_modules = ["email", "OpenGL", "unittest"]
        # 额外需要排除的dll
        self.exclude_dll = []
        # 需要加入的py文件
        self.extra_scripts = []
